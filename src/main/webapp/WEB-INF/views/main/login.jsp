...
<head>
	...
	<script src="/resources/bootstrap/js/bootstrap.min.js"></script><script>
...
<div class="login-box">
	...
	<div class="login-box-body">
		...
		<form method="post" id="form_login">
			<div class="form-group has-feedback">
				<input type="text" class="form-control" placeholder="ID" id="userId" name="userId" maxlength="20">
				<span class="glyphicon glyphicon-user form-control-feedback"></span>
			</div>
			<div class="form-group has-feedback">
				<input type="password" class="form-control" placeholder="Password" id="passwd" name="passwd" maxlength="32">
	...
	<div class="col-md-12">
		<h5 class="text-info">주식회사 <strong>미래손</strong> | <br>서울시 금천구 서부샛길 606 대성 디폴리스 A동 1301호</h5>
	</div>
</div>
<script>
