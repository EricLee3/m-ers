...
<%@include file="../include/sidebar.jsp" %>
	...
	<ul id="myTab" class="nav nav-tabs" role="tablist">
	  <li role="presentation" class="active"><a data-target="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">DashBoard</a></li>
	  <li role="presentation" class=""><a data-target="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">시스템 상태</a></li>
	</ul>
...
<iframe src="about:blank" width="800" height="600" srcrolling="auto" frameborder="0" border="0" 
bordercolor="#000000" marginwidth="0" marginheight="0" name="iframe"></iframe><p>
<a href="https://www.youtube.com/embed/jNAK7QL5JjI" target="iframe">Nzeo 제로보드^^</a><p>
	</div>
</div>
