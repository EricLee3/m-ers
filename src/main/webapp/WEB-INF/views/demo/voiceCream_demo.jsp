			...
			<div class="row" style="height: 100%;">
				<div class="col-xs-12">
					...
					<img src="/resources/img/miraeson.png" class="user-image" alt="Miraeson" style="width: 120px; height: 35px;">
						            ...
						            <div class="col-md-4">
						               <div class="box box-primary">
						                  ...
						                  <div class="box-body" style="height: 130px;">
						                        <iframe src="/record.jsp" width="100%" height="120px" scrolling="auto"  frameborder="0" marginwidth="0" marginheight="0" hspace="0" vspace="0"  border="0" bordercolor="#000000" name="iframe2" id="iframe2"></iframe>
						                  </div>
						               </div>
						            </div>
						             ...
						             <div class="col-md-4">
						               <div class="box box-primary">
						                  ...
						                  <div class="box-body">
						                     ...
						                     <button class="btn_mj btn-primary" type="button" name="excel" value="Excel" >Excel</button>
						                  </div>
						               </div>
						            </div> -->
						         </div>
						...
						<form role="form" id="form_sumbit"  action="voiceCream_demo_act" method="post" enctype="multipart/form-data">
						<div role="tabpanel" class="tab-pane active in" id="home" aria-labelledby="home-tab">
						         <div class="row" >
						           <div class="col-md-4">
						               <div class="box box-primary">
						               ...
						               <div class="box box-primary">
						                  ...
						                  <div class="box-body">
						                  	<div class="table-responsive">
						                     	<div id="circlegraph_display"  style="margin-top:20px; margin-left:5px; width:320px; height:300px;"></div>
						                     </div>
						                  </div>
						               </div>
						            </div>
