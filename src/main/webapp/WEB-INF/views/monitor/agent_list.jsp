				...
				<div class="row">
					...
					<div class="col-lg-3">
						...
						<div class="box box-danger">
							<div class="box-header with-border">
								<h3 class="box-title">오늘 콜 정보 (Anger, Stress) 차트</h3>
							</div>
							<div class="box-body">
								<div class="row">
								<c:choose>
									...
									<div class="col-md-4 ">
										<ul class="chart-legend clearfix">
											<li><i class="fa fa-square text-red"></i> Anger Call</li>
											<li><i class="fa fa-square text-yellow"></i> Stress Call</li>
