				...
				<div class="row">
					<div class="col-md-9">
						<div class="box box-info">
							...
							<!-- /.box-header -->
							<div class="box-body" id="div_call_list">
					...
					<div class="col-md-3">
						...
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">오늘 콜 정보 (Anger, Stress)</h3>
							</div>
							<div class="box-body">
						...
						<div class="box box-danger">
							<div class="box-header with-border">
								<h3 class="box-title">오늘 시간대별 A, S Call </h3>
							</div>
							<div class="box-body chart-responsive">
								<div class="chart" id="line-chart1" style="height: 180px"></div>
							</div>
						</div>
								...
								<div class="table-responsive">
									<table class="table no-margin">
										...
										<tbody>
											...
											<tr>
												<td><a href="/monitor/agent_view/${agent.index }">${agent.agentName }</a></td>
												<td>
...
$(document).ready(function(){
    ...
    function audioReload4(audio) {
    	audio.src = $("#audioPlayer2").attr("src").split("?c")[0] + "?cb=" + new Date().getTime();
    	audio.load();
		reloadAudioTimer2 = window.setInterval( function() { audioReload2(audio) }, audioReloadTime * 1000 );
		isAudio2Play = true;
    }
});
</script>
