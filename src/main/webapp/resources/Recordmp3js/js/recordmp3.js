(function(global) {
  ...
  //  WORKER_PATH = WORKER_PATH || global.workerPath + 'resources/Recordmp3js/js/recorderWorker.js';
	  WORKER_PATH = WORKER_PATH || 'resources/Recordmp3js/js/recorderWorker.js';
    try {
      encoderWorker = encoderWorker || new Worker( 'resources/Recordmp3js/js/mp3Worker.js');
    } catch (e) {
