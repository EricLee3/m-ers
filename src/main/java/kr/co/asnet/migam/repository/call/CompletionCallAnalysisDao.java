 ...
 */
public interface CompletionCallAnalysisDao {

	List<CompletionCallAnalysis> selectCompletionCallAnalysisList(PageDTO pageDTO, SearchDTO searchDTO, String orderby);
