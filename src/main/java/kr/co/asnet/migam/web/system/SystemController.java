...
public class SystemController {
	...
	public String systemLicense(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
	...
	public String licenseUpdate(License license, Model model, HisLog hislog, String username, String userid)
			throws UnknownHostException {
		...
		hislog.setDetail("[설정] 채널 라이선스 : [" + realtime + "] 실시간 분석채널 : [" + license.getRealtimeChannel()
				+ "] 비실시간 분석채널 : [" + license.getNonrealtimeChannel() + "]" + " 서비스별 라이선스 : [" + stress + "]");
	...
	public String resourceLog(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			...
			List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList15(pageDTO15, searchDTO,
			...
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				...
				List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList5(pageDTO5, searchDTO,
						"order by update_time desc");
				model.addAttribute("resourceLogList", resourceLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList(pageDTO, searchDTO,
						"order by update_time desc");
				model.addAttribute("resourceLogList", resourceLogList);
				...
				List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList25(pageDTO25, searchDTO,
						"order by update_time desc");
				model.addAttribute("resourceLogList", resourceLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList50(pageDTO50, searchDTO,
						"order by update_time desc");
				model.addAttribute("resourceLogList", resourceLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<ResourceLog> resourceLogList = resourceLogService.getResourceLogList100(pageDTO100, searchDTO,
						"order by update_time desc");
				model.addAttribute("resourceLogList", resourceLogList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
		...
		/*
		 * List<ResourceLog> categoryList =
		 * resourceLogService.getCategoryList(pageDTO15, searchDTO,
		 * "order by category asc"); model.addAttribute("categoryList",
		 * categoryList);
		 * 
		 * List<ResourceLog> levelList =
		 * resourceLogService.getLevelList(pageDTO15, searchDTO,
		 * "order by alarm_lv asc"); model.addAttribute("levelList", levelList);
		 */
	...
	public String alarmLog(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList15(pageDTO15, searchDTO,
					"order by alarmed_time desc");
			model.addAttribute("alarmLogList", alarmLogList);
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList5(pageDTO5, searchDTO,
						"order by alarmed_time desc");
				model.addAttribute("alarmLogList", alarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList(pageDTO, searchDTO,
						"order by alarmed_time desc");
				model.addAttribute("alarmLogList", alarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList25(pageDTO25, searchDTO,
						"order by alarmed_time desc");
				model.addAttribute("alarmLogList", alarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList50(pageDTO50, searchDTO,
						"order by alarmed_time desc");
				model.addAttribute("alarmLogList", alarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<AlarmLog> alarmLogList = alarmLogService.getAlarmLogList100(pageDTO100, searchDTO,
						"order by alarmed_time desc");
				model.addAttribute("alarmLogList", alarmLogList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String faultalarmLog(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList15(pageDTO15, searchDTO,
			...
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList5(pageDTO5, searchDTO,
						"order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList(pageDTO, searchDTO,
						"order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList15(pageDTO15,
						searchDTO, "order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("25")) {
				model.addAttribute("pageDTO", pageDTO25);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList25(pageDTO25,
						searchDTO, "order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList50(pageDTO50,
						searchDTO, "order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<FaultAlarmLog> faultalarmLogList = faultalarmLogService.getFaultAlarmLogList100(pageDTO100,
						searchDTO, "order by delete_time desc");
				model.addAttribute("faultalarmLogList", faultalarmLogList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String hisLog(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			...
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<HisLog> hisLogList = hisLogService.getHisLogList5(pageDTO5, searchDTO,
				...
				model.addAttribute("pageDTO", pageDTO15);
				List<HisLog> hisLogList = hisLogService.getHisLogList15(pageDTO15, searchDTO,
						"order by change_date desc");
				model.addAttribute("hisLogList", hisLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("25")) {
				model.addAttribute("pageDTO", pageDTO25);
				List<HisLog> hisLogList = hisLogService.getHisLogList25(pageDTO25, searchDTO,
						"order by change_date desc");
				model.addAttribute("hisLogList", hisLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<HisLog> hisLogList = hisLogService.getHisLogList50(pageDTO50, searchDTO,
						"order by change_date desc");
				model.addAttribute("hisLogList", hisLogList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<HisLog> hisLogList = hisLogService.getHisLogList100(pageDTO100, searchDTO,
						"order by change_date desc");
				model.addAttribute("hisLogList", hisLogList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String alarmCode(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		PageDTO pageDTO15 = new PageDTO(page);
		PageDTO2 pageDTO = new PageDTO2(page);
		PageDTO5 pageDTO5 = new PageDTO5(page);
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList15(pageDTO15, searchDTO,
					"order by alarm_code asc");
			model.addAttribute("alarmList", alarmList);
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList5(pageDTO5, searchDTO,
						"order by alarm_code asc");
				model.addAttribute("alarmList", alarmList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList(pageDTO, searchDTO,
						"order by alarm_code asc");
				model.addAttribute("alarmList", alarmList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList25(pageDTO25, searchDTO,
						"order by alarm_code asc");
				model.addAttribute("alarmList", alarmList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList50(pageDTO50, searchDTO,
						"order by alarm_code asc");
				model.addAttribute("alarmList", alarmList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<AlarmCode> alarmList = alarmCodeService.getAlarmCodeList100(pageDTO100, searchDTO,
						"order by alarm_code asc");
				model.addAttribute("alarmList", alarmList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String configLimitForm(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
		PageDTO pageDTO = new PageDTO(page);
		// AlarmLimit recognitionAlarmLimit =
		// alarmLimitService.getAlarmLimit(idx);
	...
	public String configLimit(AlarmLimit alarmLimit, Model model, SearchDTO searchDTO, HisLog hislog, String username,
			String userid, HttpServletRequest req) throws UnknownHostException {
	...
	/**
	 * 시스템::시스템 설정::상담원 목록 검색이 없을 시(첫 페이지 로딩) getSearchQuery값을 ""으로 해야 전체 출력됩니다.
	...
	public String agentList(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "sort", required = false, defaultValue = "0") int sort, Model model,
			SearchDTO searchDTO) {
	...
	public ResponseEntity<Boolean> isDuplicatedAgentId(@RequestParam(value = "agentId") String agentId) {
		...
		if (agentService.isDuplicatedAgentId(agentId))
			result = false;
		else
			result = true;
	...
	/**
	 * 시스템::시스템 설정::그룹관리 상담원 등록, 삭제, 수정될 때 그룹 테이블 mecs5_agent_group.agent_count
	 * 값이 갱신됩니다. 이 부분은 DB 에서 트리거로 처리되어 있습니다.
	 * 
	 * @param page
	 * @param model
	 * @param searchDTO
	...
	public String groupList(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<AgentGroup> groupList = agentGroupService.getAgentGroupList(pageDTO15, searchDTO,
					"order by group_id desc");
			model.addAttribute("groupList", groupList);
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<AgentGroup> groupList = agentGroupService.getAgentGroupList5(pageDTO5, searchDTO,
						"order by group_id desc");
				model.addAttribute("groupList", groupList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<AgentGroup> groupList = agentGroupService.getAgentGroupList10(pageDTO, searchDTO,
						"order by group_id desc");
				model.addAttribute("groupList", groupList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<AgentGroup> groupList = agentGroupService.getAgentGroupList25(pageDTO25, searchDTO,
						"order by group_id desc");
				model.addAttribute("groupList", groupList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<AgentGroup> groupList = agentGroupService.getAgentGroupList50(pageDTO50, searchDTO,
						"order by group_id desc");
				model.addAttribute("groupList", groupList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<AgentGroup> groupList = agentGroupService.getAgentGroupList100(pageDTO100, searchDTO,
						"order by group_id desc");
				model.addAttribute("groupList", groupList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	/*
	 * 시스템 > 시스템 설정 > 세그먼트 관리 테스트 예제입니다.
	 */
	@RequestMapping(value = "/segment_list", method = { RequestMethod.POST, RequestMethod.GET })
	public String segmentList(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		PageDTO pageDTO = new PageDTO(page);
		model.addAttribute("pageDTO", pageDTO);
		model.addAttribute("searchDTO", searchDTO);
		...
		/* CPU */
		List<ProcessGroup> processList = processGroupService.getProcessGroupList(pageDTO, searchDTO,
				"order by update_time desc");
		model.addAttribute("processList", processList);

		/* MEMORY */
		List<ProcessGroup> memoryList = processGroupService.getMemoryGroupList(pageDTO, searchDTO,
				"order by update_time desc");
		model.addAttribute("memoryList", memoryList);

		/* DISK */
		List<ProcessGroup> diskList = processGroupService.getDiskGroupList(pageDTO, searchDTO,
				"order by update_time desc");
		model.addAttribute("diskList", diskList);

		/* PROCESS */
		List<ProcessGroup> processList2 = processGroupService.getProcessList(pageDTO, searchDTO,
				"order by update_time desc");
		...
		/* 현재 알람 이력 */
		List<AlarmStatGroup> alarmstatList = processGroupService.getAlarmStatList(pageDTO, searchDTO,
				"order by alarmed_time desc");
		...
		/* fault 알람 이력 */
		List<FaultAlarmStatGroup> faultalarmstatList = processGroupService.getFaultAlarmStatList(pageDTO, searchDTO,
	...
	@ResponseBody
	public int reqcount(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
	...
	@ResponseBody
	public int reqfcount(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
	...
	@ResponseBody
	public List<ProcessGroup> reqprocess(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
	...
	@ResponseBody
	public List<ProcessGroup> reqdisk(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
	...
	@ResponseBody
	public List<FaultAlarmStatGroup> reqfaultalarm(
	...
	@ResponseBody
	public List<ProcessGroup> reqcpu(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
	...
	@ResponseBody
	public List<AlarmStatGroup> reqalarm(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO, HttpServletRequest request, HttpServletResponse response)
	...
	@ResponseBody
	public List<ProcessGroup> reqmemory(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO) {
	...
	public String sens_meta(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<SensMeta> sensmetaList = sensMetaService.getSensMetaList15(pageDTO15, searchDTO,
					"order by svc_meta_idx desc");
			model.addAttribute("sensmetaList", sensmetaList);
			searchDTO.setSearchBoardIndex("15");
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<SensMeta> sensmetaList = sensMetaService.getSensMetaList5(pageDTO5, searchDTO,
						"order by svc_meta_idx desc");
				model.addAttribute("sensmetaList", sensmetaList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<SensMeta> sensmetaList = sensMetaService.getSensMetaList(pageDTO, searchDTO,
						"order by svc_meta_idx desc");
				model.addAttribute("sensmetaList", sensmetaList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<SensMeta> sensmetaList = sensMetaService.getSensMetaList25(pageDTO25, searchDTO,
						"order by svc_meta_idx desc");
				model.addAttribute("sensmetaList", sensmetaList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<SensMeta> sensmetaList = sensMetaService.getSensMetaList50(pageDTO50, searchDTO,
						"order by svc_meta_idx desc");
				model.addAttribute("sensmetaList", sensmetaList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<SensMeta> sensmetaList = sensMetaService.getSensMetaList100(pageDTO100, searchDTO,
						"order by svc_meta_idx desc");
				model.addAttribute("sensmetaList", sensmetaList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String sens_basic(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<SensBasic> sensbasicList = sensBasicService.getSensBasicList15(pageDTO15, searchDTO,
					"order by name desc");
			...
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<SensBasic> sensbasicList = sensBasicService.getSensBasicList5(pageDTO5, searchDTO,
						"order by name asc");
				model.addAttribute("sensbasicList", sensbasicList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<SensBasic> sensbasicList = sensBasicService.getSensBasicList(pageDTO, searchDTO,
						"order by name asc");
				model.addAttribute("sensbasicList", sensbasicList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<SensBasic> sensbasicList = sensBasicService.getSensBasicList25(pageDTO25, searchDTO,
						"order by name asc");
				model.addAttribute("sensbasicList", sensbasicList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<SensBasic> sensbasicList = sensBasicService.getSensBasicList50(pageDTO50, searchDTO,
						"order by name asc");
				model.addAttribute("sensbasicList", sensbasicList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<SensBasic> sensbasicList = sensBasicService.getSensBasicList100(pageDTO100, searchDTO,
						"order by name asc");
				model.addAttribute("sensbasicList", sensbasicList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	/*
	 * 
	 * @RequestMapping(value = "/selectSensConf", method = {RequestMethod.GET,
	 * RequestMethod.POST}) public String selectSensConf( @RequestParam(value =
	 * "groupId", required = false, defaultValue = "1") String groupId,PageDTO
	 * pageDTO, Model model, SearchDTO searchDTO) {
	 * 
	 * 
	 * String[] array; array = groupId.split(",");
	 * 
	 * searchDTO.setSearchQuery(array[0]); searchDTO.setSearchId(array[1]);
	 * 
	 * List<SensConf> svIndiList = sensConfService.getSensConf(pageDTO,
	 * searchDTO, "order by name desc"); model.addAttribute("svIndiList",
	 * svIndiList); return "/system/sens_conf"; //메인페이지가 완성되지 않아 임시 주석처리합니다. }
	 * 
	 */

	@RequestMapping(value = "/selectSensConf", method = { RequestMethod.POST, RequestMethod.GET })
	@ResponseBody
	public List<Map> reqMent(@RequestParam(value = "groupId", required = false, defaultValue = "1") String groupId,
			PageDTO2 pageDTO, Model model, SearchDTO searchDTO, String Mentval) throws UnsupportedEncodingException {
	...
	@ResponseBody
	public List<Map> selectProConf(
			@RequestParam(value = "groupId", required = false, defaultValue = "1") String groupId, PageDTO2 pageDTO,
			Model model, SearchDTO searchDTO, String Mentval) throws UnsupportedEncodingException {
	...
	@ResponseBody
	public List<Map> selectSvList(@RequestParam(value = "name", required = false, defaultValue = "1") String name,
			PageDTO2 pageDTO, Model model, SearchDTO searchDTO, String Mentval) throws UnsupportedEncodingException {
	...
	@ResponseBody
	public List<Map> selectAgentProfileList(
			@RequestParam(value = "name", required = false, defaultValue = "1") String name, PageDTO2 pageDTO,
			Model model, SearchDTO searchDTO, String Mentval) {
		...
		for (int i = 0; i < ProChkList.size(); i++) {
			...
			/*
			 * map.put("service_idx", ProChkList.get(i).getService_idx());
			 * map.put("name", ProChkList.get(i).getName()); map.put("sv_min",
			 * ProChkList.get(i).getSv_min()); System.out.println("aa:::" +
			 * ProChkList.get(i).getSv_min()); map.put("sv_max",
			 * ProChkList.get(i).getSv_max());
			 */
			Mentlist.add(map);
		}
	...
	@ResponseBody
	public List<Map> selectSvList2(@RequestParam(value = "name", required = false, defaultValue = "1") String name,
			PageDTO2 pageDTO, Model model, SearchDTO searchDTO, String Mentval) throws UnsupportedEncodingException {
		String name_de = URLDecoder.decode(name, "UTF-8");
		searchDTO.setSearchId(name_de);
		// List<SensConf> svIndiList = sensConfService.getSensConf(pageDTO,
	...
	@ResponseBody
	public List<Map> selectLevelList(@RequestParam(value = "name", required = false, defaultValue = "1") String name,
			PageDTO2 pageDTO, Model model, SearchDTO searchDTO, String Mentval) {
	...
	public String sens_conf(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		if (searchDTO.getSearchQuery() == null) {
			searchDTO.setSearchQuery("");
			if (searchDTO.getStartDate() == null) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<SensConf> sensconfList = sensConfService.getSensConfList15(pageDTO15, searchDTO,
					"ORDER BY NAME ASC, emotion_level ASC");
			model.addAttribute("sensconfList", sensconfList);
			searchDTO.setSearchBoardIndex("15");
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<SensConf> sensconfList = sensConfService.getSensConfList5(pageDTO5, searchDTO,
						"ORDER BY NAME ASC, emotion_level ASC");
				model.addAttribute("sensconfList", sensconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<SensConf> sensconfList = sensConfService.getSensConfList(pageDTO, searchDTO,
						"ORDER BY NAME ASC, emotion_level ASC");
				model.addAttribute("sensconfList", sensconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<SensConf> sensconfList = sensConfService.getSensConfList25(pageDTO25, searchDTO,
						"ORDER BY NAME ASC, emotion_level ASC");
				model.addAttribute("sensconfList", sensconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<SensConf> sensconfList = sensConfService.getSensConfList50(pageDTO50, searchDTO,
						"ORDER BY NAME ASC, emotion_level ASC");
				model.addAttribute("sensconfList", sensconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<SensConf> sensconfList = sensConfService.getSensConfList100(pageDTO100, searchDTO,
						"ORDER BY NAME ASC, emotion_level ASC");
				model.addAttribute("sensconfList", sensconfList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String pro_meta(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<ProMeta> prometaList = proMetaService.getProMetaList15(pageDTO15, searchDTO,
					"order by profile_meta_idx desc");
			model.addAttribute("prometaList", prometaList);
			searchDTO.setSearchBoardIndex("15");
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<ProMeta> prometaList = proMetaService.getProMetaList5(pageDTO5, searchDTO,
						"order by profile_meta_idx desc");
				model.addAttribute("prometaList", prometaList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<ProMeta> prometaList = proMetaService.getProMetaList(pageDTO, searchDTO,
						"order by profile_meta_idx desc");
				model.addAttribute("prometaList", prometaList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<ProMeta> prometaList = proMetaService.getProMetaList25(pageDTO25, searchDTO,
						"order by profile_meta_idx desc");
				model.addAttribute("prometaList", prometaList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<ProMeta> prometaList = proMetaService.getProMetaList50(pageDTO50, searchDTO,
						"order by profile_meta_idx desc");
				model.addAttribute("prometaList", prometaList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<ProMeta> prometaList = proMetaService.getProMetaList100(pageDTO100, searchDTO,
						"order by profile_meta_idx desc");
				model.addAttribute("prometaList", prometaList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String pro_conf(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO) {
		if (searchDTO.getSearchQuery() == null) {
			searchDTO.setSearchQuery("");
			if (searchDTO.getStartDate() == null) {
		...
		if (searchDTO.getSearchBoardIndex() == null) {
			model.addAttribute("pageDTO", pageDTO15);
			List<ProConf> proconfList = proConfService.getProConfList15(pageDTO15, searchDTO,
					"order by d.PROFILE_IDX desc");
			model.addAttribute("proconfList", proconfList);
			searchDTO.setSearchBoardIndex("15");
		} else {
			if (searchDTO.getSearchBoardIndex().equals("5")) {
				model.addAttribute("pageDTO", pageDTO5);
				List<ProConf> proconfList = proConfService.getProConfList5(pageDTO5, searchDTO,
						"order by d.PROFILE_IDX desc");
				model.addAttribute("proconfList", proconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("10")) {
				model.addAttribute("pageDTO", pageDTO);
				List<ProConf> proconfList = proConfService.getProConfList(pageDTO, searchDTO,
						"order by d.PROFILE_IDX desc");
				model.addAttribute("proconfList", proconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("15")) {
				model.addAttribute("pageDTO", pageDTO15);
				...
				model.addAttribute("pageDTO", pageDTO25);
				List<ProConf> proconfList = proConfService.getProConfList25(pageDTO25, searchDTO,
						"order by d.PROFILE_IDX desc");
				model.addAttribute("proconfList", proconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("50")) {
				model.addAttribute("pageDTO", pageDTO50);
				List<ProConf> proconfList = proConfService.getProConfList50(pageDTO50, searchDTO,
						"order by d.PROFILE_IDX desc");
				model.addAttribute("proconfList", proconfList);
			} else if (searchDTO.getSearchBoardIndex().equals("100")) {
				model.addAttribute("pageDTO", pageDTO100);
				List<ProConf> proconfList = proConfService.getProConfList100(pageDTO100, searchDTO,
						"order by d.PROFILE_IDX desc");
				model.addAttribute("proconfList", proconfList);
			} else {
				model.addAttribute("pageDTO", pageDTO15);
	...
	public String sens_demo(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO, PageDTO2 pageDTO) {
		List<ProMeta> IndiList = proMetaService.getIndiList(pageDTO, searchDTO, "order by name desc");
		model.addAttribute("IndiList", IndiList);
		model.addAttribute("menu", "prometa");
		model.addAttribute("menuCategory", "system");
	...
	public String voiceCream_demo(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			Model model, SearchDTO searchDTO, PageDTO2 pageDTO) {
		List<ProMeta> IndiList = proMetaService.getIndiList(pageDTO, searchDTO, "order by name desc");
		model.addAttribute("IndiList", IndiList);
	...
	public String sens_demo_act(PageDTO2 pageDTO, SearchDTO searchDTO, HttpServletRequest request,
			HttpServletResponse response, MultipartHttpServletRequest reqm, String svr_array, Model model)
		...
		if (uploadfile != null) {
			...
			try {
				...
				File file = new File(
						"C:/home/mecs/PSNR/record/" + year + "/" + mm + "/" + dd + "/" + hh + "/" + fileName);
				if (!file.exists()) {
					// 디렉토리 생성 메서드
					file.mkdirs();
				...
				// 로컬
				// String exeFile =
				// "C:/Users/in.lee/workspace/projects/M-ERS/src/main/sox-14.2.0/sox
				// "+file+" -b 16 -r 8000 -c 1
				// "+"C:/home/mecs/PSNR/record/"+year+"/"+mm+"/"+dd+"/"+hh+"/"+soxfilename;
				// TB
				// String exeFile =
				// "C:/tomcat/webapps/src_20161102_mers/sox-14.2.0/sox "+file+"
				// -b 16 -r 8000 -c 1
				// "+"C:/home/mecs/PSNR/record/"+year+"/"+mm+"/"+dd+"/"+hh+"/"+soxfilename;

				// TM presentation
				// String exeFile =
				// "C:/tomcat/apache-tomcat-8.5.16-windows-x64/apache-tomcat-8.5.16/webapps/mers/sox-14.2.0/sox
				// "+file+" -b 16 -r 8000 -c 1
				// "+"C:/home/mecs/PSNR/record/"+year+"/"+mm+"/"+dd+"/"+hh+"/"+soxfilename;

				String soxdir = appProp.getProperty("sox.dir");
				String exeFile = soxdir + " " + file + " -b 16 -r 8000 -c 1 " + "C:/home/mecs/PSNR/record/" + year + "/"
						+ mm + "/" + dd + "/" + hh + "/" + soxfilename;
				...
				voicefile.setAgent_voice_filename("C:\\home\\mecs\\PSNR\\record\\" + year + "\\" + mm + "\\" + dd + "\\"
						+ hh + "\\" + soxfilename);
				...
				recognition_job.setJob_id("WEB_" + sdformat.format(calendarNow.getTime())); // call_id
																							// =
																							// job_id
				...
				if (tri_hh < 10)
					tri_hhstr = "0" + String.valueOf(tri_hh);
				else
					tri_hhstr = String.valueOf(tri_hh);
				if (tri_mi < 10)
					tri_mistr = "0" + String.valueOf(tri_mi);
				else
					tri_mistr = String.valueOf(tri_mi);
				if (tri_ss < 10)
					tri_ssstr = "0" + String.valueOf(tri_ss);
				else
					tri_ssstr = String.valueOf(tri_ss);
	...
	public String voiceCream_demo_act(PageDTO2 pageDTO, SearchDTO searchDTO, HttpServletRequest request,
			HttpServletResponse response, MultipartHttpServletRequest reqm, String svr_array, Model model)
			throws UnsupportedEncodingException, FileUploadException {
		request.setCharacterEncoding("utf-8");
		MultipartFile uploadfile = reqm.getFile("wavfile");
		...
		if (uploadfile != null) {
			...
			try {
				...
				recognition_job.setJob_id("WEB_" + sdformat.format(calendarNow.getTime())); // call_id
																							// =
																							// job_id
				recognition_job.setJob_name("WEB_" + sdformat.format(calendarNow.getTime())); // call_id
																								// =
																								// job_id
				recognition_job.setStart_time(sdformat.format(calendarNow.getTime()));
				recognition_job.setEnd_time(year + mm + dd);
	...
	@ResponseBody
	public List<Map> reqMent(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO, String Mentval) {
		PageDTO pageDTO = new PageDTO(page);
	...
	@ResponseBody
	public int sens_resultCnt(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO, String call_id) {
		PageDTO pageDTO = new PageDTO(page);
	...
	@ResponseBody
	public int sens_failcode(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO, String call_id) {
		PageDTO pageDTO = new PageDTO(page);
		searchDTO.setSearchQuery(call_id);
		/* minju add */
	...
	public @ResponseBody String linegraph(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			SearchDTO searchDTO, Locale locale, Model model, String call_id) {
		Gson gson = new Gson();

		PageDTO pageDTO = new PageDTO(page);
		searchDTO.setSearchQuery(call_id);
		List<AnalResult> AnlResultList = sensDemoService.getAnalResultList(pageDTO, searchDTO,
	...
	public @ResponseBody String linegraph_csv(
			@RequestParam(value = "page", required = false, defaultValue = "1") int page, SearchDTO searchDTO,
			Locale locale, Model model, String call_id) {
		Gson gson = new Gson();
	...
	public @ResponseBody String circle(@RequestParam(value = "page", required = false, defaultValue = "1") int page,
			SearchDTO searchDTO, Locale locale, Model model, String call_id) {
		Gson gson = new Gson();
	...
	public String demo_excel(@RequestParam(value = "page", required = false, defaultValue = "1") int page, Model model,
			SearchDTO searchDTO, PageDTO2 pageDTO, String excel_call_id) {
		// List<ProMeta> IndiList = proMetaService.getIndiList(pageDTO,
		// searchDTO, "order by name desc");
	...
	public @ResponseBody String demo_excel_act(
			@RequestParam(value = "page", required = false, defaultValue = "1") int page, SearchDTO searchDTO,
			Locale locale, Model model, String call_id) {
		Gson gson = new Gson();
		...
		for (int i = 0; i < ExceliList.size(); i++) {
			 ...
			 * 
			 * if(j == 0){ if(dname.equals("start_pos")) { resultstr[0] =
			 * "Start Pos"; }else if(dname.equals("end_pos")) { resultstr[0] =
			 * "End Pos"; }else { resultstr[0] = String.valueOf(dname); } }else{
			 * // resutlval_sub2 =
			 * Double.parseDouble(resutlval_sub[j-1].toString()); resutlval_sub2
			 * =String.valueOf(resutlval_sub[j-1].toString()); resultstr[j] =
			 * String.valueOf(resutlval_sub2); }
			 * 
			 * }
			 */
			...
			/*
			 * HashMap hashmap = new HashMap(); hashmap = new HashMap();
			 * hashmap.put("aname", dname); hashmap.put("bdata", resutlval);
			 * hashlist.add(hashmap);
			 */
			mj[i] = resultstr;
