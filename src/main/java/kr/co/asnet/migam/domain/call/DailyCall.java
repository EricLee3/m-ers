 ...
 *  데이터베이스 테이블 : mecs5_service_stat_daily
 *  위 2개의 테이블을 모두 사용하며, 두 테이블의 차이점은  agentId 컬럼 유무입니다. ( agent_id 필드는 mecs5_agent_stat_daily 테이블에만 있습니다.)
 */
@SuppressWarnings("serial")
public class DailyCall extends BaseDomain {
	...
	public String toString() {
		return "DailyCall [statTime=" + statTime + ", agentId=" + agentId + ", totalCount=" + totalCount
