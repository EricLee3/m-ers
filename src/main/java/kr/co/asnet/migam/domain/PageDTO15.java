 ...
 * 페이징 도메인 클래스
 */
public class PageDTO15 { 
	public static final int DEFAULT_PAGE = 1;
	public static final int DEFAULT_ITEM_PER_PAGE = 15;
	...
	public PageDTO15(int page, int itemPerPage) {
		this.page = page;
	...
	public String toString() {
		return "PageDTO15 [startRow=" + startRow + ", endRow=" + endRow + ", page=" + page + ", pagePerGroup=" + pagePerGroup + ", itemPerPage=" + itemPerPage + "]";
	}
