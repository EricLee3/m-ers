...
public class FaultAlarmHisGroup extends BaseDomain {
	...
	public String toString() {
		return "FaultAlarmStatGroup [sys_id="+sys_id+", sys_name=" + sys_name + ", code=" + code + ", happened_time=" + happened_time + ", delete_time=" + delete_time + ", detail=" + detail+"]";
	}
